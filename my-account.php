...
if(strlen($_SESSION['login']) == 0) {   
    ...
    if(isset($_POST['submit'])) {
        ...
        $confirmPassword = md5($_POST['cnfpass']);
        ...
        if($currentPassword == $passwordInDB) {
            if($newPassword == $confirmPassword) {
                $updatePasswordQuery = mysqli_query($con, "UPDATE users SET password='$newPassword', updationDate='$currentTime' WHERE id='".$_SESSION['id']."'");
