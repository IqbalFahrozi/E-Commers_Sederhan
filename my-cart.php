                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="cart-qty item">Kuantitas</th>
                                            <th class="cart-sub-total item">Harga per unit</th>
                                            <th class="cart-sub-total item">Biaya pengiriman</th>
                                        ...
                                        <tr>
                                            <td colspan="7">
                                                <div class="shopping-cart-btn">
                                                    <span class="">
                                                        <a href="index.php"
                                                            class="btn btn-upper btn-primary outer-left-xs">Lanjutkan
                                                            Belanja</a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="cart-image">
                                                <a
                                                    ...
                                                    <img src="data:image/jpeg;base64,<?php echo $gambar1; ?>"
...
?>
                                                        <div class="reviews">
                                                            ( <?php echo htmlentities($num);?> Ulasan )
                                                        </div>
                                                        <?php } ?>
                                                    </div>
                                                </div><!-- /.row -->
                                            ...
                                            <td class="cart-product-sub-total"><span
                                                    class="cart-sub-total-price"><?php echo "Rp"." ".$row['productPrice']; ?>.00</span>
                                            </td>
                                            <td class="cart-product-sub-total"><span
                                                    class="cart-sub-total-price"><?php echo "Rp"." ".$row['shippingCharge']; ?>.00</span>
                                            </td>
...
?>
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing Address">Alamat
                                                    Penerima<span>*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing State ">Kota Penerima
                                                    <span>*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing City">Kabupaten
                                                    Penerima<span>*</span></label>
                                                <input type="text" class="form-control unicase-form-control text-input"
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing Pincode">Kode pos
                                                    <span>*</span></label>
                                                <input type="text" class="form-control unicase-form-control text-input"
