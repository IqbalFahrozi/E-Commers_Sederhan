...
<head>
    ...
    <title>Peyek Nyai| Signi-in | Signup</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="sign-in-page inner-bottom-sm">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 sign-in">
                        <h4 class="">Masuk</h4>
                        <p class="">Hello, Selamat datang diakun anda.</p>
...
?>
                    ...
                    <div class="col-md-6 col-sm-6 create-new-account">
                        ...
                        <p class="text title-tag-line">Buat akun Belanja Anda sendiri.</p>
                        <form class="register-form outer-top-xs" role="form" method="post" name="register"
                            ...
                            <div class="form-group">
                                <label class="info-title" for="contactno">No Kontak. <span>*</span></label>
                            ...
                            <div class="form-group">
                                <label class="info-title" for="confirmpassword">Konfirmasi Password.
                                    <span>*</span></label>
                                <input type="password" class="form-control unicase-form-control text-input"
                        ...
                        <span class="checkout-subtitle outer-top-xs">Daftar Hari ini Dan Anda Akan Dapat : </span>
                        <div class="checkbox">
                            <label class="checkbox">
                                Percepat jalan Anda melalui kasir.
                            </label>
                            <label class="checkbox">
