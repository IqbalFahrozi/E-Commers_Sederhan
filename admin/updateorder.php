    ...
    <div style="margin-left:50px;">
        <form name="updateticket" id="updateticket" method="post">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr height="30">
                    <td class="fontkink1"><b>Bukti:</b></td>
                    <td class="fontkink">
                        <?php
$bu = mysqli_query($con, "SELECT * FROM bukti WHERE order_id='$oid'");
while ($but = mysqli_fetch_array($bu)) {
    $gambar = base64_encode($but['bukti']); // Mengonversi blob menjadi string base64
    echo "<img src='data:image/jpeg;base64,".$gambar."' width='200' height='150' alt='Bukti Gambar'>";
}
?>
                ...
                <?php
                $bu = mysqli_query($con, "SELECT * FROM bukti ");
                while ($but = mysqli_fetch_array($bu)) {
                }
                ?>
                <?php
