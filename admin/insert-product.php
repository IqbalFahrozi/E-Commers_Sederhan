...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $productimage1 = addslashes(file_get_contents($_FILES["productimage1"]["tmp_name"]));
        $productimage2 = addslashes(file_get_contents($_FILES["productimage2"]["tmp_name"]));
        $productimage3 = addslashes(file_get_contents($_FILES["productimage3"]["tmp_name"]));
