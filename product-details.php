...
while ($rws=mysqli_fetch_array($ret)) {
                                    $gambar1 = base64_encode($rws['productImage1']);
                                    $gambar2 = base64_encode($rws['productImage2']);
                                    $gambar3 = base64_encode($rws['productImage3']);
                                    ...
                                    <div class="products">
                                        <div class="hot-deal-wrapper">
                                            <a href="product-details.php?pid=<?php echo htmlentities($row['id']); ?>">
                                                <img src="data:image/jpeg;base64,<?php echo $gambar1; ?>" width="180"
                                                    height="300" alt="">
                                            </a>
                                        ...
                                        <div class="product-info text-left m-t-20">
                                            <h3 class="name"><a
                                                    href="product-details.php?pid=<?php echo htmlentities($rws['id']);?>"><?php echo htmlentities($rws['productName']);?>
                                                </a>
                                            </h3>
                                            ...
                                            <div class="product-price">
                                                ...
                                                <span
                                                    class="price-before-discount">Rp.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
...
{
                    // Mengonversi blob menjadi string base64
                                ...
                                <div id="owl-single-product">
                                    ...
                                    <div class="single-product-gallery-item" id="slide1">
                                        <a data-lightbox="image-1"
                                            ...
                                            <img src="data:image/jpeg;base64,<?php echo $gambar1; ?>" width="370"
                                                height="350" alt="">
                                        </a>
                                    </div>
                                    ...
                                    <div class="single-product-gallery-item" id="slide2">
                                        <a data-lightbox="image-1"
                                            href="product-details.php?pid=<?php echo htmlentities($row['id']); ?>">
                                            <img src="data:image/jpeg;base64,<?php echo $gambar2; ?>" width="370"
                                                height="350" alt="">
                                        </a>
                                    </div><!-- /.single-product-gallery-item -->
                                    ...
                                    <div class="single-product-gallery-item" id="slide3">
                                        <a data-lightbox="image-1"
                                            href="product-details.php?pid=<?php echo htmlentities($row['id']); ?>">
                                            <img src="data:image/jpeg;base64,<?php echo $gambar3; ?>" width="100"
                                                height="150" alt="tes">
                                        </a>
                                    </div>
                                    ...
                                    <div id="owl-single-product-thumbnails">
                                        <div class="item">
                                            <a class="horizontal-thumb active" data-target="#owl-single-product"
                                                ...
                                                <img src="data:image/jpeg;base64,<?php echo $gambar1; ?>" width="80"
                                                    height="170" alt="">
                                            </a>
                                        </div>
                                        ...
                                        <div class="item">
                                            <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="1"
                                                href="#slide1">
                                                <img src="data:image/jpeg;base64,<?php echo $gambar2; ?>" width="80"
                                                    height="170" alt="">
                                            </a>
                                        </div>
                                        <div class="item">
                                            ...
                                            <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="1"
                                                href="#slide1">
                                                <img src="data:image/jpeg;base64,<?php echo $gambar3; ?>" width="80"
                                                    height="170" alt="">
                                            </a>
                                        </div>
...
{
                    $gambar1 = base64_encode($rw['productImage1']);
                    $gambar2 = base64_encode($rw['productImage2']);
                    $gambar3 = base64_encode($rw['productImage3']);
                            ...
                            <div class="product-image">
                                <div class="image">
                                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1"
                                        href="#slide1">
                                        <img src="data:image/jpeg;base64,<?php echo $gambar1; ?>" width="150"
                                            height="240" alt="">
                                    </a>
                                </div><!-- /.image -->
